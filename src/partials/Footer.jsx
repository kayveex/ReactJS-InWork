    ...
    <>
      <footer className="bg-lime-800 shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800">
        ...
        <div className="flex justify-center items-center space-x-4">
          {/* Instagram */}
          <a
            href="https://www.instagram.com/kayveex/"
            target="_blank"
            rel="noopener noreferrer"
            data-tooltip-target="tooltip-instagram"
            className="inline-flex justify-center p-2 text-lime-100 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600"
          >
