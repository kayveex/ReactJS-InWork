...
export const CusNavbar = () => {
  return (
    <>
      <nav className="bg-white sticky  w-full border-gray-200 px-4 lg:px-14 py-4 dark:bg-gray-800 drop-shadow-md	cusnav">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="/" className="flex items-center">
            <img src="/logo-inwork.png" className="mr-3 h-6 sm:h-9" alt="InWork Logo" />
            <span className="text-lime-700 self-center text-xl font-bold whitespace-nowrap dark:text-white">InWork</span>
          </a>
          <div className="flex items-center lg:order-2">
            <a
              href="#"
              className=" text-lime-700 font-black dark:text-white hover:text-lime-900 focus:ring-4 focus:ring-gray-300  rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
            >
              Login
            </a>
            <a
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 ml-1 text-sm text-lime-700 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
